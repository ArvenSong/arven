...
public class DtoCodeGenerator {
	 ...
	 * 包名
	 */
	private static final String PACKAGE_NAME = "cn.com.trade365.platform";
	/**
	 * 模块名称
	 */
	...
	private static final String URL = "jdbc:mysql://192.168.153.23:3306/trade?useUnicode=true&characterEncoding=UTF-8";
...
//		TableFill modifiedField = new TableFill("gmt_update", FieldFill.INSERT_UPDATE);
...
//								.setInclude(new String[] {"us_user"}) // 需要生成的表
								...
								// 自定义实体，公共字段
//								.setSuperEntityColumns(new String[]{"gmt_create","gmt_update","version"})
