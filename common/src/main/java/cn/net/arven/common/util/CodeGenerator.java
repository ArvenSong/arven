...
public class CodeGenerator {
	 ...
	 * 包名
	 */
	private static final String PACKAGE_NAME = "cn.net.arven";
	/**
	 * 模块名称
	 */
	...
	public static void main(String[] args) {
		...
		// 如下是配置
		TableFill createField = new TableFill("version", FieldFill.INSERT);
		...
		AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
				...
				new GlobalConfig().setOutputDir(OUT_PATH)// 输出目录
						...
						.setXmlName("%sMapper").setMapperName("%sDao").setDateType(DateType.ONLY_DATE).setIdType(IdType.ID_WORKER)
...
//								.setInclude(new String[] {"us_user"}) // 需要生成的表
								...
								// 自定义实体，公共字段
//								.setSuperEntityColumns(new String[]{"gmt_create","gmt_update"})
